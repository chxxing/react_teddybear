const main_content = [
    ...
    { id: 2, strong: "국내 유일의 테디베어 박물관", title: "여 수", des: "여수앞바다에 상륙한 하와이 테디베어의 모든 것", link: "/place/jeju" },
    { id: 3, strong: "국내 유일의 테디베어 박물관", title: "군 산", des: "타임요트를 타고 떠나는 시공간 여행", link: "/place/jeju" },
    { id: 4, strong: "국내 유일의 테디베어 박물관", title: "청 두", des: "대륙의 중심, 판다의 고향에서 만나는 테디베어", link: "/place/jeju" }
];
